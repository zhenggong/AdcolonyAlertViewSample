...
- (void)viewDidLoad {
	...
	_alertView = [[UIAlertView alloc] initWithTitle:@"AlertView"
											message:@"iOS7"
										   delegate:self
...
- (void)alertView:(UIAlertView *)alertView didDismissWithButtonIndex:(NSInteger)buttonIndex {
	 [AdColony playVideoAdForZone:kAdColonyZoneID withDelegate:self withV4VCPrePopup:NO andV4VCPostPopup:NO];
}
